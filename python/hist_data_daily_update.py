...
url_head_k = 'http://pdfm.eastmoney.com/em_ubg_pdti_fast/api/js?cb=jQuery183&TYPE=k&style=top&num=1&rtntype=1&id='
url_list_k = [url_head_k+stock_ids for stock_ids in stock_id_for_url]

url_head_m5k = 'http://pdfm.eastmoney.com/em_ubg_pdti_fast/api/js?cb=jQuery183&TYPE=m5k&style=top&num=48&rtntype=1&id='
url_list_m5k = [url_head_m5k+stock_ids for stock_ids in stock_id_for_url]

url_head_m15k = 'http://pdfm.eastmoney.com/em_ubg_pdti_fast/api/js?cb=jQuery183&TYPE=m15k&style=top&num=16&rtntype=1&id='
url_list_m15k = [url_head_m15k+stock_ids for stock_ids in stock_id_for_url]

url_head_m30k = 'http://pdfm.eastmoney.com/em_ubg_pdti_fast/api/js?cb=jQuery183&TYPE=m30k&style=top&num=8&rtntype=1&id='
url_list_m30k = [url_head_m30k+stock_ids for stock_ids in stock_id_for_url]

url_head_m60k = 'http://pdfm.eastmoney.com/em_ubg_pdti_fast/api/js?cb=jQuery183&TYPE=m60k&style=top&num=4&rtntype=1&id='
...
if __name__ == '__main__':
    ...
    print('日k线历史数据日更新下载完成')
    multicore(url_list_m5k)
    print('5分钟k线历史数据日更新下载完成')
    multicore(url_list_m15k)
    print('15分钟k线历史数据日更新下载完成')
    multicore(url_list_m30k)
    print('30分钟k线历史数据日更新下载完成')
    multicore(url_list_m60k)
    print('60分钟k线历史数据日更新下载完成')
