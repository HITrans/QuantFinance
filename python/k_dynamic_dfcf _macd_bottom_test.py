...
url_head_k = 'http://pdfm.eastmoney.com/em_ubg_pdti_fast/api/js?cb=jQuery183&TYPE=k&style=top&num=41&rtntype=1&id='
...
def multicore(url_k_type):
    with Pool(40) as p:
        ...
        for _ in tqdm(p.imap_unordered(mp_job, url_k_type), total=len(url_k_type)):
            pass
